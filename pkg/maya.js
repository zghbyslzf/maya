 ...
 * @returns {number}
 */
module.exports.clear_lock_files = function(dir) {
    const ptr0 = passStringToWasm0(dir, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.clear_lock_files(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {number}
 */
module.exports.clear_node_modules = function(dir) {
    const ptr0 = passStringToWasm0(dir, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.clear_node_modules(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
